...
* Description: YDS Support Ticket System enables you to easily create your own ticket system on your WordPress Theme. Users can submit/create tickets, ticket agents can answer tickets, change the ticket status, create categories, upload files and set priority. With a shortcode, you can display the create ticket form on the frontend. Visitors can register or login in order to get support, check status or create tickets. Admin can also allow guest users to make use of support system.
* License: GPL v2
* Version: 1.0
